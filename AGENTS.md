...
- New sessions should read `AGENTS.md` and `docs/current_status.md` first.
...
- Allowed here: startup rules, repo-wide workflow constraints, concise document-routing rules.
